...
//   return (
//     <header className="bg-white border-b shadow-sm fixed top-0 left-0 right-0 z-50 h-16">
//       <div className="flex items-center justify-between px-4 h-full">
//         {/* Left: hamburger + logo/title */}
//         <div className="flex items-center gap-3 flex-1">
//           {/* Mobile hamburger (kept exactly as your style) */}
//           <button
...
//                 setShowProfileMenu(false)
//               }}
//               className="text-gray-600 hover:text-blue-600 relative p-2 rounded-lg hover:bg-gray-100 transition-colors touch-target"
...
//             {showNotifications && (
//               <div
//                 className="absolute right-0 mt-2 w-80 bg-white border rounded-lg shadow-lg z-50 modal-container"
//                 role="menu"
//                 aria-label="Notifications"
//               >
...
//                 setShowNotifications(false)
//               }}
//               className="flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 transition-colors touch-target"
...
//                 {user?.name}
//               </span>
//               <i className="fas fa-chevron-down text-gray-500 text-xs hidden sm:block"></i>
//             </button>

//             {showProfileMenu && (
//               <div
//                 className="absolute right-0 mt-2 w-48 bg-white border rounded-lg shadow-lg z-50 modal-container"
//                 role="menu"
...
//                     className="w-full text-left px-3 py-3 text-sm text-gray-700 hover:bg-gray-100 rounded flex items-center touch-target"
//                     role="menuitem"
//                   >
...
//                     className="w-full text-left px-3 py-3 text-sm text-red-600 hover:bg-red-50 rounded flex items-center touch-target"
//                     role="menuitem"
//                   >
