        ...
        <div className="flex min-h-[82px] items-center justify-between">
          ...
          <div className="ml-auto hidden items-center gap-2 lg:flex lg:pl-8">
            ...
            <div className="flex items-center gap-3">
              <Link
                to="/login"
                className="inline-flex items-center rounded-full border border-slate-200 bg-white px-5 py-2.5 text-sm font-medium text-slate-700 shadow-[0_10px_24px_rgba(15,23,42,0.04)] transition-all duration-200 hover:-translate-y-0.5 hover:border-sky-200 hover:bg-sky-50 hover:text-[#005EB8] hover:shadow-[0_14px_28px_rgba(0,94,184,0.12)]"
              >
                Sign In
              </Link>
              <Link
        ...
        <div className="lg:hidden border-t border-gray-200 bg-white/95 backdrop-blur-md">
          <div className="mx-auto max-w-[88rem] px-4 py-4 sm:px-6">
            ...
            <div className="flex flex-col gap-3 border-t border-gray-200 pt-4 sm:flex-row">
              <Link 
                to="/login" 
                className="flex-1 rounded-xl border border-slate-200 bg-white px-2 py-3 text-center text-base font-medium text-slate-700 shadow-sm transition-all duration-200 hover:border-sky-200 hover:bg-sky-50 hover:text-[#005EB8]"
                onClick={() => setOpen(false)}
              >
                Sign In
              </Link>
