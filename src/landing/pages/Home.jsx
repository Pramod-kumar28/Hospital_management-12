    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
      {[
        { 
          ...
          desc: "Comprehensive patient registration, medical history, and appointment scheduling.",
          hoverDetails: [
            "Digital patient registration with photo capture",
            "Medical history tracking & chronic disease management",
        ...
        { 
          ...
          hoverDetails: [
            ...
            "Lab test ordering & result viewing",
            "Telemedicine consultation scheduling",
            "Medical reference databases integration"
          ]
        },
        { 
          icon: CreditCard, 
      ...
      ].map(({ icon: Icon, title, desc, hoverDetails }) => (
        <div 
  key={title} 
...
>
  ...
  <div className="relative z-10 transition-all duration-500 group-hover:opacity-0 group-hover:translate-y-[-20px]">
    <span className="inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-500 text-white mb-4 shadow-md">
      <Icon size={24} className="md:w-7 md:h-7" />
    </span>
  ...
  <div className="absolute inset-0  md:p-2 flex flex-col justify-center transform translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
    <div className="bg-gradient-to-br from-blue-500 to-cyan-500 text-white rounded-xl p-4 md:p-6 shadow-lg">
      <h4 className="font-bold text-xl mb-4">Features Include:</h4>
      <div className="space-y-2 max-h-[180px] overflow-y-auto pr-2">
        {hoverDetails.map((detail, index) => (
          <div key={index} className="flex items-start gap-3">
            <CheckCircle2 className="w-4 h-4 md:w-5 md:h-5 text-green-300 flex-shrink-0 mt-1.5" />
  ...
  {/* <div className="absolute bottom-4 right-4">
    <div className="bg-white/90 backdrop-blur-sm text-blue-600 px-3 py-1.5 rounded-full text-xs font-medium opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-md">
