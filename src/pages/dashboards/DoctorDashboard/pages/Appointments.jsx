...
//                 </button>
//                 <button className="text-green-500 hover:text-green-700" title="Complete">
...
//           <h3 className="text-lg font-semibold mb-3">Appointment Statistics</h3>
//           <div className="space-y-3">
//             <div className="flex justify-between">
//               <span>Confirmed</span>
//               <span className="font-semibold">{appointments.filter(a => a.status === 'Confirmed').length}</span>
//             </div>
//             <div className="flex justify-between">
//               <span>Pending</span>
//               <span className="font-semibold">{appointments.filter(a => a.status === 'Pending').length}</span>
//             </div>
//             <div className="flex justify-between">
//               <span>Cancelled</span>
...
//         <div className="bg-white p-4 rounded border card-shadow md:col-span-2">
...
//             <div className="flex justify-between">
//               <span>Cancelled</span>
//               <span className="font-semibold">{appointments.filter(a => a.status === 'Cancelled').length}</span>
//             </div>
//             <div className="flex justify-between">
//               <span>Completed</span>
//               <span className="font-semibold">{appointments.filter(a => a.status === 'Completed').length}</span>
//             </div>
//           </div>
//         </div>
...
//           <h3 className="text-lg font-semibold mb-3">Upcoming Schedule</h3>
//           <div className="space-y-3">
//             {appointments.filter(apt => apt.status === 'Pending' || apt.status === 'Confirmed').slice(0, 3).map(apt => (
//               <div key={apt.id} className="flex items-center justify-between p-3 border rounded hover:bg-gray-50">
//                 <div className="flex items-center">
//                   <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center mr-3">
//                     <i className="fas fa-user text-blue-600"></i>
...
//         <h2 className="text-2xl md:text-3xl font-semibold text-gray-700">Appointments</h2>
//         <button
//           onClick={() => setIsScheduleModalOpen(true)}
...
//             sortable: true,
//             render: (value) => (
//               <span className={`status-badge ${value === 'Confirmed' ? 'status-confirmed' :
//                   value === 'Completed' ? 'status-completed' :
//                     value === 'Cancelled' ? 'status-cancelled' : 'status-pending'
//                 }`}>
//                 {value}
...
//             title: 'Type',
//             render: (value) => (
//               <span className={`status-badge ${value === 'Urgent' ? 'status-urgent' :
//                   value === 'Emergency' ? 'status-urgent' : 'status-pending'
//                 }`}>
//                 {value}
//               </span>
...
//                 <button
//                   onClick={() => handleEditAppointment(row)}
//                   className="text-blue-500 hover:text-blue-700 p-1 rounded hover:bg-blue-50 touch-target"
//                   title="Edit"
//                 >
//                   <i className="fas fa-edit"></i>
//                 </button>
//                 <button
//                   onClick={() => handleCompleteAppointment(row.id)}
//                   className="text-green-500 hover:text-green-700 p-1 rounded hover:bg-green-50 touch-target"
//                   title="Complete"
//                 >
//                   <i className="fas fa-check"></i>
//                 </button>
//                 <button
//                   onClick={() => handleCancelAppointment(row.id)}
//                   className="text-red-500 hover:text-red-700 p-1 rounded hover:bg-red-50 touch-target"
//                   title="Cancel"
//                 >
//                   <i className="fas fa-times"></i>
//                 </button>
...
//         <div className="card bg-white rounded-lg p-4 shadow-sm">
//           <h3 className="text-lg md:text-xl font-semibold mb-3">Appointment Statistics</h3>
//           <div className="space-y-3">
//             <div className="flex justify-between">
//               <span>Confirmed</span>
//               <span className="font-semibold">{appointments.filter(a => a.status === 'Confirmed').length}</span>
...
//         <div className="card bg-white rounded-lg p-4 shadow-sm md:col-span-2">
//           <h3 className="text-lg md:text-xl font-semibold mb-3">Upcoming Schedule</h3>
//           <div className="space-y-3">
//             {appointments
...
//       {/* Header */}
//       <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6">
//         <h2 className="text-xl md:text-2xl lg:text-3xl font-semibold text-gray-700 text-responsive">Appointments</h2>
//         <button
//           onClick={() => setIsScheduleModalOpen(true)}
...
//                 title: 'Type',
//                 render: (value) => (
//                   <span className={`status-badge ${value === 'Urgent' || value === 'Emergency' ? 'status-urgent' :
//                       'status-active'
//                     }`}>
//                     {value}
//                   </span>
...
//                       }}
//                       className="text-blue-500 hover:text-blue-700 rounded hover:bg-blue-50 modal-touch-target"
//                       title="Edit Appointment"
//                     >
...
//                       onClick={(e) => {
//                         e.stopPropagation()
//                         handleCompleteAppointment(row.id)
//                       }}
//                       className="text-green-500 hover:text-green-700 rounded hover:bg-green-50 modal-touch-target"
...
//                       }}
//                       className="text-red-500 hover:text-red-700 rounded hover:bg-red-50 modal-touch-target"
...
//       {/* Statistics Cards */}
//       <div className="grid-responsive mobile-stack">
//         <div className="card card-responsive card-shadow card-mobile">
//           <h3 className="text-lg font-semibold mb-4 text-responsive">Appointment Statistics</h3>
//           <div className="space-y-3 md:space-y-4">
//             <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
//               <span className="text-gray-700 text-sm md:text-base">Confirmed</span>
//               <span className="font-semibold text-base md:text-lg text-blue-600">
//                 {appointments.filter(a => a.status === 'Confirmed').length}
//               </span>
//             </div>
//             <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
//               <span className="text-gray-700 text-sm md:text-base">Pending</span>
//               <span className="font-semibold text-base md:text-lg text-yellow-600">
//                 {appointments.filter(a => a.status === 'Pending').length}
//               </span>
//             </div>
//             <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
//               <span className="text-gray-700 text-sm md:text-base">Cancelled</span>
//               <span className="font-semibold text-base md:text-lg text-red-600">
//                 {appointments.filter(a => a.status === 'Cancelled').length}
//               </span>
//             </div>
//             <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg">
//               <span className="text-gray-700 text-sm md:text-base">Completed</span>
...
//         <div className="card card-responsive card-shadow md:col-span-2 card-mobile">
//           <h3 className="text-lg font-semibold mb-4 text-responsive">Upcoming Schedule</h3>
//           <div className="space-y-3 md:space-y-4">
//             {appointments
//               .filter(apt => apt.status === 'Pending' || apt.status === 'Confirmed')
//               .slice(0, 3)
...
//                 <div
//                   key={apt.id}
//                   className="flex flex-col sm:flex-row sm:items-center justify-between p-3 md:p-4 border border-gray-200 rounded-lg hover:bg-gray-50 card-hover transition-all duration-200 mobile-stack"
//                 >
//                   <div className="flex items-center space-x-3 mb-2 sm:mb-0">
//                     <div className="w-10 h-10 md:w-12 md:h-12 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
//                       <i className="fas fa-user text-blue-600 text-base md:text-lg"></i>
//                     </div>
