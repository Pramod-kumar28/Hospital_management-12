...
const Messaging = () => {
  ...
  const sourceLabel = (source) => {
    if (source === "telemed")
      return { label: "Telemedicine", color: "blue", icon: "video" };
          ...
          <div className="space-y-3 max-h-96 overflow-y-auto mb-4 pr-1">
            {messages.map((msg) => {
              ...
              return (
                ...
                >
                  <div
                    className={`w-10 h-10 rounded-full flex items-center justify-center mr-3 flex-shrink-0 bg-${src.color}-100`}
                  >
                    {isMarking ? (
                      <i className="fas fa-spinner fa-spin text-gray-400"></i>
                    ) : (
                      <i
                        className={`fas fa-${src.icon} text-${src.color}-600`}
                      ></i>
                    )}
                  </div>
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-start gap-2">
                      <div className="min-w-0">
                        ...
                        <span
                          className={`text-xs text-${src.color}-600 bg-${src.color}-50 px-1.5 py-0.5 rounded`}
                        >
                          {src.label}
                        </span>
                      </div>
          ...
          <div className="bg-white p-4 border rounded card-shadow">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center p-2 bg-orange-50 rounded-lg">
                <span className="text-sm text-gray-600 flex items-center gap-2">
                  <i className="fas fa-envelope-open text-orange-500"></i>{" "}
                  Unread
                </span>
              ...
              <div className="flex justify-between items-center p-2 bg-green-50 rounded-lg">
                <span className="text-sm text-gray-600 flex items-center gap-2">
                  <i className="fas fa-prescription-bottle-alt text-green-500"></i>{" "}
                  Prescription
                </span>
              ...
              {[
                ...
                >
                  <div className="flex items-center">
                    <i
                      className={`fas fa-${setting.icon} text-gray-400 mr-3 w-5 text-center`}
                    ></i>
