...
//     setTimeout(() => {
//       setPatients([
//         { id: 1, name: "Ravi Kumar", age: 32, gender: "Male", city: "Mumbai", allergies: "None", lastVisit: "2023-10-15", conditions: ["Hypertension"] },
//         { id: 2, name: "Anita Sharma", age: 28, gender: "Female", city: "Delhi", allergies: "Penicillin", lastVisit: "2023-10-10", conditions: ["Asthma"] },
//         { id: 3, name: "Suresh Patel", age: 45, gender: "Male", city: "Bangalore", allergies: "None", lastVisit: "2023-10-05", conditions: ["Diabetes", "Hypertension"] },
//         { id: 4, name: "Priya Singh", age: 35, gender: "Female", city: "Chennai", allergies: "Sulfa", lastVisit: "2023-09-28", conditions: ["Migraine"] }
//       ])
//       setLoading(false)
//     }, 1000)
//   }
...
//               <button className="bg-blue-500 text-white px-3 py-1 text-xs rounded hover:bg-blue-600">
//                 <i className="fas fa-flask mr-1"></i> Tests
//               </button>
//               <button className="bg-green-500 text-white px-3 py-1 text-xs rounded hover:bg-green-600">
//                 <i className="fas fa-history mr-1"></i> History
//               </button>
//               <button className="bg-purple-500 text-white px-3 py-1 text-xs rounded hover:bg-purple-600">
...
const PatientRecords = ({ onPageChange }) => {
  ...
  const handleOrderTest = () => {
    if (selectedTest) {
      alert(`Test ordered for ${selectedPatient.name}: ${selectedTest}`)
  ...
  const handlePrescriptionSubmit = () => {
    if (prescription.medication && prescription.dosage && prescription.frequency && prescription.duration) {
      alert(`Prescription created for ${selectedPatient.name}:\nMedication: ${prescription.medication}\nDosage: ${prescription.dosage}\nFrequency: ${prescription.frequency}\nDuration: ${prescription.duration}`)
