...
const [lastUpdateSource, setLastUpdateSource] = useState(null);
  ...
  const [newReport, setNewReport] = useState({
    ...
    hospitalId: "", // For hospital selection dropdown
    hospitalIdDisplay: "", // Display field for hospital ID

    // Services Usage
    servicesUsed: [], // Array of selected services
    serviceStartDate: "", // Service start date
    serviceEndDate: "", // Service end date
    totalDuration: "", // Calculated duration
    serviceStatus: "active", // Current service status

    // Issues & Resolution Tracking
    hasIssue: false, // Checkbox for issues
    issueTitle: "", // Issue title
    issueReportedDate: "", // When issue was reported
    issueDescription: "", // Detailed issue description
    resolutionStatus: "pending", // pending, in_progress, resolved

    // Service Upgrades
    hasUpgrade: false, // Checkbox for upgrades
    upgradeType: "", // feature, plan, performance, security
    upgradeDate: "", // When upgrade was provided
    upgradeDescription: "", // Upgrade details

    // Performance Metrics
    systemUptime: "", // Platform uptime percentage
    avgResponseTime: "", // Average API response time in ms
    errorRate: "", // Error rate percentage

    // Legacy performance fields (keep for backward compatibility)
    total_hospitals: "",
    active_hospitals: "",
    inactive_hospitals: "",
    total_users: "",
...
const handleGenerateReport = async (e) => {
  ...
  const resetNewReportForm = () => {
    setNewReport({
      ...
      custom_date_range: "last_30_days",
      ...
      comparison_benchmark: "previous_period",
